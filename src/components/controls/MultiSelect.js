...
export default class MultiSelect extends Component {
  ...
  render() {
    ...
    return <div style={this.props.style} className={this.props.className}>
      {label}
      <ReactSelect {...select} ref="input" value={this.props.selected} multi={true} openOnFocus={true}
                   onChange={this.props.onChange} placeholder={this.props.placeholder} disabled={this.props.disabled}
                   style={{
